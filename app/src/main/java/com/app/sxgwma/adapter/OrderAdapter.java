...
//        holder.tv.setText(mDatas.get(position));
    ...
    protected  void setUpItemEvent(final OrderViewHolder holder) {
    ...
    @Override
    public OrderViewHolder onCreateViewHolder(ViewGroup arg0, int arg1) {
        View view=this.mInflater.inflate(R.layout.order_fragment_item,arg0,false);
...
class OrderViewHolder extends RecyclerView.ViewHolder{
    TextView tv;
    public OrderViewHolder(View arg0){
        super(arg0);
